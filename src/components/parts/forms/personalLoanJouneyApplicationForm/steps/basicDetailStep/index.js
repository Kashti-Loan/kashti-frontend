...
const BasicDetailStep = (props) => {
  ...
  const defaultValues = {
    ...
    pan: loanData?.pan || "",
    educational_qualification: loanData?.educational_qualification || "",
  };
  ...
  async function onSubmit(data) {
    ...
    try {
      ...
      setCurrentStep(isJourneyOne ? 2 : 4);
    ...
    <div className={styles.formSection}>
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className={styles.radioGrpBlock}>
            <h3>Select your maximum qualification*</h3>
            <div className={styles.radioGrpInnerEducation}>
              <RadioTextButton
                label="Undergraduate"
                checked={
                  getValues("educational_qualification") == "Undergraduate"
                }
                onChange={() =>
                  setValue("educational_qualification", "Undergraduate", {
                    shouldValidate: true,
                  })
                }
              />
              <RadioTextButton
                label="Graduate"
                checked={getValues("educational_qualification") == "Graduate"}
                onChange={() =>
                  setValue("educational_qualification", "Graduate", {
                    shouldValidate: true,
                  })
                }
              />
              <RadioTextButton
                label="Post Graduate"
                checked={
                  getValues("educational_qualification") == "post-graduate"
                }
                onChange={() =>
                  setValue("educational_qualification", "post-graduate", {
                    shouldValidate: true,
                  })
                }
              />
              <RadioTextButton
                label="Others"
                checked={getValues("educational_qualification") == "others"}
                onChange={() =>
                  setValue("educational_qualification", "others", {
                    shouldValidate: true,
                  })
                }
              />
