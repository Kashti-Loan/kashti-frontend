          ...
          <Row>
            <Col xs={12} md={6} lg={4}>
              <div className={styles.whyKashtiBox}>
                ...
                <Text>Instant access to funds without hassles and delays.</Text>
              </div>
            </Col>
            <Col xs={12} md={6} lg={4}>
              <div className={styles.whyKashtiBox}>
            ...
            <Col xs={12} md={6} lg={4}>
              <div className={styles.whyKashtiBox}>
                ...
                <Text>Choice of tenure options for convenient repayment.</Text>
              </div>
            </Col>
            <Col xs={12} md={6} lg={4}>
              <div className={styles.whyKashtiBox}>
                ...
                <Text>Complete peace of mind with 100% approved lenders.</Text>
              </div>
            </Col>
            <Col xs={12} md={6} lg={4}>
              <div className={styles.whyKashtiBox}>
              ...
              <ul className={styles.instantPersonalLoanStepsList}>
                ...
                <li>
                  ...
                  <div>
                    ...
                    <p>Compare bank offers to find the best option for you.</p>
                  </div>
                </li>
                <li>
                  <h4>4</h4>
