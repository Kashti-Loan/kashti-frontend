...
const Page = ({ params }) => {
  ...
  const [personalLoanEligibilityAccordian, setPersonalLoanEligibilityAccordian] = useState(false);
  return (
        ...
        <Container>
          <Row>
            <Col xs={12} md={12} lg={11}>
              <PersonalLoanForm apiKey={params.apiKey} secretKey={params.secretKey} />
            </Col>
            <Col xs={12} md={12} lg={11}>
            ...
            <Col xs={12} md={12} lg={11}>
              <div className={`${styles.infoAccordian} ${personalLoanAccordian ? styles.activeAccordian : styles.inActiveAccordian}`}>
                <div className={styles.infoAccordianHeader} onClick={() => setPersonalLoanAccordian((prev) => !prev)}>
                ...
                <div className={styles.infoAccordianContent}>
                  <ul>
                    ...
                    <li>Loan amounts up to Rs. 40 lakh can be borrowed and can be increased at the discretion of the lender.</li>
                    <li>Flexible repayment period, ranging from 1 to 5 years, depending on the lender.</li>
                    <li>Very little documentation is required for loan processing.</li>
                    <li>Competitive interest rates, beginning at 10.50% p.a., further decreased depending on the lender.</li>
                    <li>Fastest loan disbursement compared to any other lending platform.</li>
                    <li>Opportunity for pre-approved loans with instant disbursement for those with excellent credit scores.</li>
                  </ul>
                </div>
              </div>
            </Col>
            <Col xs={12} md={12} lg={11}>
              <div className={`${styles.infoAccordian} ${personalLoanEligibilityAccordian ? styles.activeAccordian : styles.inActiveAccordian}`}>
                <div className={styles.infoAccordianHeader} onClick={() => setPersonalLoanEligibilityAccordian((prev) => !prev)}>
                ...
                <div className={styles.infoAccordianContent}>
                  <ul>
                    ...
                    <li>
                      <b>Income</b>: As low as Rs 15,000/month for salaried applicants
                    </li>
                    <li>
                      <b>Credit Score</b>: A score of 750 or above is recommended, as it increases the likelihood of loan approval and reduced
                      interest rates.
                    </li>
                    <li>
